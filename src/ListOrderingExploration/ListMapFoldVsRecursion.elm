...
{-| Comparing whether the naive implementation for the list reversing `altMap` function from `ListOrderingExploration.ListMap`
...
Related benchmarks: ListOrderingExploration.ListMap, ImprovingPerformance.ElmCore.ListLength
